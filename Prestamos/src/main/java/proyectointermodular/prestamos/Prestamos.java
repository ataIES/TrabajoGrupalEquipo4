...
public class Prestamos extends javax.swing.JFrame {
    ...
    private void mostrarImagen() {
        ...
        Icon fondoSolicitar = new ImageIcon(fondo.getImage().
                getScaledInstance(lblFondoSolicitar.getWidth(),
                        lblFondoSolicitar.getHeight(), fondo.getIconWidth()));
        lblFondoSolicitar.setIcon(fondoSolicitar);
        
        Icon fondoCalcular = new ImageIcon(fondo.getImage().
                getScaledInstance(lblFondoCalcular.getWidth(),
                        lblFondoCalcular.getHeight(), fondo.getIconWidth()));
        lblFondoCalcular.setIcon(fondoCalcular);
        
        Icon fondoMostrar = new ImageIcon(fondo.getImage().
                getScaledInstance(lblFondoMostrar.getWidth(),
                        lblFondoMostrar.getHeight(), fondo.getIconWidth()));
        lblFondoMostrar.setIcon(fondoMostrar);
        
        Icon fondoFirmar = new ImageIcon(fondo.getImage().
                getScaledInstance(lblFondoFirmar.getWidth(),
                        lblFondoFirmar.getHeight(), fondo.getIconWidth()));
        lblFondoFirmar.setIcon(fondoFirmar);
...
/* Corregir metodo*/
    ...
    private void escribirFichero() {
        ...
        List<PrestamoPreconcedido>lista=new ArrayList();
        try {
            if (fichero.exists()) {
